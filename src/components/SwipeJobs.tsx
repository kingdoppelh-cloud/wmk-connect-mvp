...
import { SlidersHorizontal, Euro, MapPin, ArrowRight, PlayCircle, Users, PartyPopper, Timer, Train, Dumbbell, Coins, MousePointerClick, X, Heart } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-slate-950 text-slate-50 font-sans h-[100dvh] w-full overflow-hidden animate-in slide-in-from-bottom-full duration-500">
            ...
            <header className="absolute top-0 left-0 right-0 z-[100] px-6 py-6 flex justify-between items-center pointer-events-none">
                ...
                <button className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center pointer-events-auto border border-white/20 text-white hover:bg-white/20">
            ...
            >
                ...
                <section className="flex-none w-full h-full relative snap-center overflow-hidden">
                    <img className="absolute inset-0 w-full h-full object-cover" src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?auto=format&fit=crop&q=80" alt="Chef Cooking" />
                    ...
                    <div className="absolute bottom-32 left-0 right-0 px-8 flex flex-col gap-6">
                        ...
                        <div>
                            <h2 className="text-6xl font-black leading-[0.9] tracking-tighter mb-2 text-white">KOCH<br />(M/W/D)</h2>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-white/10 backdrop-blur-xl border border-white/10 p-5 rounded-[2rem]">
                                ...
                                <p className="text-2xl font-black text-white">€3.8k</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-xl border border-white/10 p-5 rounded-[2rem]">
                                <MapPin className="text-accent mb-2" size={24} />
                                <p className="text-[10px] text-white/50 uppercase font-bold tracking-widest">Ort</p>
                                <p className="text-2xl font-black text-white truncate">{company.address.split(',')[0]}</p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flex-none w-full h-full relative snap-center bg-slate-900 overflow-hidden">
                    <div className="p-8 pt-32 h-full flex flex-col">
                        <h3 className="text-5xl font-black mb-8 leading-[0.9] text-white">THE TEAM<br /><span className="text-accent">VIBE.</span></h3>
                        <div className="flex-1 space-y-6">
                            <div className="relative h-64 rounded-3xl overflow-hidden group shadow-2xl">
                                <img className="w-full h-full object-cover opacity-70 grayscale group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700" src="https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&q=80" alt="Team" />
                                <div className="absolute inset-0 flex items-center justify-center bg-accent/20 group-hover:bg-transparent transition-colors duration-500">
                            ...
                            <div className="grid grid-cols-1 gap-6 mt-8">
                                <div className="flex items-start gap-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-white/60 leading-relaxed font-medium">Wir sind ein Team von 12 Köpfen, die das Kochen lieben und Hierarchien hassen.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-5">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center shrink-0 border border-white/10">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-lg text-white mb-1">After-Work Events</h4>
                                        <p className="text-sm text-white/60 leading-relaxed font-medium">Regelmäßige Team-Abende und gemeinsames Testen neuer Menüs und Konzepte.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative z-10 p-8 pt-32 h-full flex flex-col">
                        ...
                        <div className="grid grid-cols-2 gap-4 flex-1 pb-16">
                            <div className="bg-white/5 backdrop-blur-xl p-6 rounded-[2.5rem] flex flex-col justify-between border-t-accent border-t-4 border border-white/5">
                                ...
                                <div>
                                    <p className="text-2xl font-black italic text-white drop-shadow-md">4-TAGE</p>
                                    <p className="text-[10px] uppercase font-bold text-white/50 tracking-widest mt-1">Woche möglich</p>
                                </div>
                            </div>
                            <div className="bg-white/5 backdrop-blur-xl p-6 rounded-[2.5rem] flex flex-col justify-between border border-white/5">
                                ...
                                <div>
                                    <p className="text-2xl font-black italic text-white drop-shadow-md">FREE</p>
                                    <p className="text-[10px] uppercase font-bold text-white/50 tracking-widest mt-1">Job-Ticket</p>
                                </div>
                            </div>
                            <div className="bg-white/5 backdrop-blur-xl p-6 rounded-[2.5rem] flex flex-col justify-between border border-white/5">
                                <Dumbbell className="text-accent" size={36} />
                                <div>
                                    <p className="text-2xl font-black italic text-white drop-shadow-md">GYM</p>
                                    <p className="text-[10px] uppercase font-bold text-white/50 tracking-widest mt-1">Membership</p>
                                </div>
                            </div>
                            <div className="bg-white/5 backdrop-blur-xl p-6 rounded-[2.5rem] flex flex-col justify-between border-b-accent border-b-4 border border-x-white/5 border-t-white/5">
                                ...
                                <div>
                                    <p className="text-2xl font-black italic text-white drop-shadow-md">BONUS</p>
                                    <p className="text-[10px] uppercase font-bold text-white/50 tracking-widest mt-1">Trinkgeld-Pool</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flex-none w-full h-full relative snap-center bg-slate-950 overflow-hidden">
                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <h3 className="text-6xl font-black text-white mb-6 leading-[0.9] tracking-tighter">THE CALL<br />IS YOURS.</h3>
                        <p className="text-white/60 text-lg mb-16 max-w-[280px] font-medium leading-relaxed">Bist du der nächste Star in unserer Küche? Entscheide dich jetzt.</p>

                        <div className="flex gap-8 items-center">
                            <button onClick={onClose} className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center text-white border border-white/10 hover:bg-white/10 transition-all group backdrop-blur-md">
                                <X size={32} className="group-hover:scale-110 transition-transform opacity-70" />
                            </button>
                            <button
                                onClick={() => {
                                    alert("Bewerbung per One-Click gesendet! 🎉 (Demo)");
                                    onClose();
                                }}
